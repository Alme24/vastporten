...
export default function ReportError({ onClose }: ReportErrorProps) {
    ...
    return (
        ...
        >
            <div 
                className="relative flex flex-col justify-start items-center bg-base-de-botoones rounded-xl md:p-12 p-4 w-[90%] max-w-11/12 max-h-[90vh] overflow-y-auto"
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="flex flex-col md:grid sm:grid-cols-6 gap-4 w-full my-6">
                    ...
                    <div className="col-span-6 flex gap-4 md:w-[45%]">
                        <input
                            type="checkbox"
                            name="privacy"
