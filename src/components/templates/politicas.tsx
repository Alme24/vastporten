        ...
        <div className="bg-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2  justify-items-end">
                <div className="px-8 lg:px-16 lg:pt-36">
                    ...
                    />
                    <Subtitle 
                        description={`En esta política de privacidad, explicamos cómo y con qué finalidad procesamos sus datos personales y qué derechos tiene usted como sujeto de datos bajo el Reglamento General de Protección de Datos, normalmente abreviado como GDPR.
                    ...
                    <Subtitle
                        subtitle="Qué son los datos personales y qué significa el tratamiento de datos personales?"
            ...
            <div className="text-left w-full px-8 pt-1 lg:px-16">
                ...
                <div className="p-8 justify-items-center">
                    <Subtitle
                        subtitle="Sus datos personales podrán ser compartidos con las siguientes categorías de destinatarios:"
                    ></Subtitle>
                ...
                ></Subtitle>
                <Subtitle
                    subtitle= "¿Por qué tratamos sus datos?"
                    description={`Cuando compra un servicio de administración de propiedades en Väst AB, procesamos su información para poder brindar y administrar su servicio.
                ...
                ></Subtitle>
                <Subtitle
                    subtitle="Contáctenos sobre nuestro procesamiento de datos personales"
                ></Subtitle>
                ...
                <Subtitle
                    subtitle="Cambios a esa Política de Privacidad"
                    description={`Esta Política de Privacidad sustituye a las versiones anteriores. Fastighetsförvaltning i Väst AB podrá modificarla ocasionalmente. La última versión siempre está disponible en nuestro sitio web.`}
                ></Subtitle>
            </div>
            <Footer />
        </div>
