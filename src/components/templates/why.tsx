...
export default function Why(){
    return (
        ...
        <div className="bg-white h-28 pb-14"></div>
            ...
            >
                <p className="font-['Noto_Sans_Telugu'] text-[#4C4C4C] leading-relaxed text-center text-[16px] font-normal py-18 max-w-lg">
            ...
            <motion.div
                className="bg-[#F4F4F4] rounded-[8px] w-4/5 mx-auto"
            ...
            >
                <div className="grid grid-cols-[400px_auto] gap-x-10 p-8 items-center justify-items-center">
                    <Image
                        src="/images/imagen25.webp"
                        alt=""
                        width={400}
                        height={424}
